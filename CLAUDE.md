...
Corpus: `A literal is a postfix head`, `Literal heads do not disturb the readings they contest`, `A constructor call is a postfix head`, `A constructor head does not disturb the readings it contests` (expressions/postfix.txt), `A parenthesized expression is a postfix head`, `A constructor call is a math operand` (math_operators.txt).
